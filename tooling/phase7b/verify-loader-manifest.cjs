...
if (require.main === module) {
  try {
    console.log(`PASS: loader manifest matches 56 + 41 loaded entries (${verify().length} total), 8 source-only inputs, 1 standalone script, 4 generated bundles and site inventory`);
  } catch (error) {
