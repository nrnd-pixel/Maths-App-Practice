...
console.log('PASS: Phase 7D-C dormant flat-loader prototype preserves the 47 -> 41 symbolic order, authority predecessors, tier-2 duplicate guards and release-identity boundary without changing production bytes.');
