...
(() => {
  ...
  function applyV50StableRelease(){
    ...
    loadScriptOnce('v47-intervention-history.js?v=47a-1', 'data-v47c-intervention-history');
    ...
    loadScriptOnce('v49-student-topic-progress.js?v=49b-2', 'data-v49-student-topic-progress');
