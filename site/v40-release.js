...
(() => {
  ...
  function applyV51StableRelease(){
    ...
    loadScriptOnce('v50-roster-edit.js?v=50launch-1', 'data-v50launch-roster-edit');
    loadScriptOnce('v51-paper-profile-validator.js?v=51a-1', 'data-v51a-paper-profile-validator');
    ...
    loadScriptOnce('v51-exam-publication-ui-polish.js?v=51b3-ui-3', 'data-v51b3-ui-exam-publication-ui-polish');
    ...
    loadScriptOnce('v50-security-hardening.js?v=50rc2-1', 'data-v50rc2-security-hardening');
    loadScriptOnce('v50-production-polish.js?v=51stable-1', 'data-v51stable-production-polish');
    loadScriptOnce('v50-release-audit.js?v=50rc2-1', 'data-v50rc2-release-audit');
    loadScriptOnce('v50-rc2-empty-result-code-polish.js?v=50rc2-empty-1', 'data-v50rc2-empty-result-code-polish');
    loadScriptOnce('v50-release-audit-rc3.js?v=51stable-1', 'data-v51stable-release-audit-rc3');
