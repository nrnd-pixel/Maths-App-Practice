/* V4.7 release presentation — Intervention History & Follow-Up.
   Loads the established V4.1–V4.7 foundation plus staged V4.8 teacher and student workflow improvements. */
(() => {
  'use strict';
  ...
  function applyV47Release(){
    ...
    loadScriptOnce('v48-student-deadline-experience.js?v=48b-1', 'data-v48b-student-deadline-experience');
  }
