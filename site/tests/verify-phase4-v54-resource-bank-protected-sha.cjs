...
const protectedFiles=Object.freeze({
  ...
  // V52 complete runtime boundary, including V54G performance owner.
  ...
  // Historical V54 references and release checkpoint stay exact.
...
console.log(`Phase 4 V54 protected SHA audit passed: ${rows.length} files + complete Supabase tree.`);
