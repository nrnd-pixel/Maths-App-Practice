...
expect(release.includes("loadScriptOnce('assignment-interventions.js', 'data-assignment-interventions')"),'Shared Focus behavior must remain inside the consolidated V44 owner');
