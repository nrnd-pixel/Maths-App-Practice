...
const packagePreview=fs.readFileSync(path.join(root,'paper-import-management.js'),'utf8');
const paperProfile=fs.readFileSync(path.join(root,'paper-import-management.js'),'utf8');
const integrity=fs.readFileSync(path.join(root,'paper-import-management.js'),'utf8');
const qa=fs.readFileSync(path.join(root,'question-bank-selection-qa.js'),'utf8');
const review=fs.readFileSync(path.join(root,'question-bank-metadata-review.js'),'utf8');
const history=fs.readFileSync(path.join(root,'question-bank-audit-multipart.js'),'utf8');
