...
assert(release.includes("loadScriptOnce('v53a-practice-eligibility.js?v=53a-1', 'data-v53a-practice-eligibility');"),'V5.3A module must be loaded by the stable release loader');

console.log('V5.3A Practice eligibility checks passed.');
